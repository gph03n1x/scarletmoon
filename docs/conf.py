...
# -*- coding: utf-8 -*-
#
# Scarlet Moon documentation build configuration file, created by
...
copyright = '2017, Giannis Papaioannou'
...
latex_documents = [
    (master_doc, 'ScarletMoon.tex', 'Scarlet Moon Documentation',
...
man_pages = [
    (master_doc, 'scarletmoon', 'Scarlet Moon Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ScarletMoon', 'Scarlet Moon Documentation',
     author, 'ScarletMoon', 'One line description of project.',
     'Miscellaneous'),
]
